    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-4 dark:bg-zinc-950">
      ...
      >
        <div className="mb-8 text-center">
          <Link to="/" className="text-3xl font-bold tracking-tighter text-black dark:text-white">
        ...
        <Card>
          ...
          <CardFooter className="flex flex-col space-y-4 border-t border-zinc-100 pt-6 dark:border-zinc-800">
            <div className="text-center text-sm text-zinc-500 dark:text-zinc-400">
              Não tem uma conta?{' '}
              <Link to="/register" className="font-semibold text-black hover:underline dark:text-white">
                Crie uma agora
              </Link>
            </div>
